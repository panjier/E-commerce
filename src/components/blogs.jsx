        ...
        <div className="card">
          ...
          <div className="card-body">
            <p className="mb-3">
              ...
              quia rerum perspiciatis maiores eaque id molestias optio nesciunt
              tempora quibusdam nisi quaerat, magnam aspernatur assumenda.
              Labore nihil a architecto ipsam.
            </p>
