  ...
  <div className="col-3">
    <div className="card">
        ...
        <div className="card-body">
            <p className='mb-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, quia rerum perspiciatis maiores eaque id molestias optio nesciunt tempora quibusdam nisi quaerat, magnam aspernatur assumenda. Labore nihil a architecto ipsam.</p>
