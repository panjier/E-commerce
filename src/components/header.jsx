        ...
        <div className='row align-items-center'>
          ...
          <div className="col-6 d-flex justify-content-between">
            ...
            <div>
              ...
              <Link><HiOutlineMail className='fs-5 mx-4' /></Link>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container-xxl"></div>
        <div className="row">
          ...
          <span class="input-group-text" id="basic-addon1">All</span>
            ...
            <button className="input-group-text" id="basic-addon2"><FiSearch /></button>
          </div>
          </div>
          ...
          <div className="nav-links-nav col-3 d-flex align-items-center justify-content-around">
              ...
              <span><BiSolidHeart className='fs-5 mx-2'/></span>
              </div>
              </Link>           
              <Link to={'login'} className={location.pathname === '/login' ? 'active' : 'inactive'}>    
              <div className='d-flex m-2 '>    
              <span><RiAccountCircleFill className='fs-5 mx-2'/></span>
              </div>
              </Link>           
              <Link to={'cart'} className={location.pathname === '/cart' ? 'active' : 'inactive'}>    
              <div className='d-flex m-2'>    
              <span><IoMdCart className='fs-5 mx-2'/></span>
              </div>
              </Link>                     
          </div>
        </div>
